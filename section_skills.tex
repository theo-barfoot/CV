...
\begin{keywords}
		\keywordsentry{Programming}{Python, MATLAB, Latex, Pycharm, Jupyter, Git}
		\keywordsentry{Machine Learning}{Spring, Spring Boot, \textbf{Ionic 3}, Angular 2, Angular 4, ZK, JBoss RichFaces}
